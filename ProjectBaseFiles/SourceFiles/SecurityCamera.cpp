...
SecurityCamera::SecurityCamera(const std::string& name, const SecurityAlarm& alarm, MotionDetector* motionDetector)
    : SecurityDevice(name, alarm), motionDetector(motionDetector) {}
